                ...
                <div className="flex lg:flex-row flex-col gap-10 justify-evenly xl:px-0 px-3 items-center my-[5em] w-full text-black">
                    <div className="flex flex-col w-[450px] h-[300px] gap-[2em] justify-center items-center lg:shadow-2xl shadow-none p-2 white">
                        ...
                        <div className="flex flex-col gap-[2em] justify-center">
                            ...
                            <p className="xl:text-[18px] text-[16px] px-2 lg:text-justify text-center">Booking with us is a breeze!
                    ...
                    <div className="flex flex-col w-[450px] h-[300px] gap-[2em] justify-center items-center lg:shadow-2xl shadow-none p-2 white">
                        ...
                        <div className="flex flex-col gap-[2em] justify-center">
                            ...
                            <p className="xl:text-[18px] text-[16px] px-2 lg:text-justify text-center">Absolutely! We take pride in curating a selection of accommodations that meet our high standards of comfort and authenticity.
                    ...
                    <div className="flex flex-col w-[450px] h-[300px] gap-[2em] justify-center items-center lg:shadow-2xl shadow-none p-2 white">
                        ...
                        <div className="flex flex-col gap-[2em] justify-between">
                            ...
                            <p className="xl:text-[18px] text-[16px] px-2 lg:text-justify text-center">We're here for you! Feel free to reach out to our dedicated support team through our Contact Us page.

        ...
        <>
            <footer ref={contactUsRef} className=" bg-zinc-800 h-auto flex lg:flex-row pl-2 flex-col justify-evenly items-start py-[3em] gap-[3em] w-full xl:mt-0 lg:mt-[4em]">
                <div>
                    ...
                    <p className="text-gray-400 max-w-[30em] lg:text-[19px] text-[18px]">
                        We are more than just a booking platform we are
                        architects of unforgettable experiences and champions of
            ...
            <div className="bg-zinc-900 lg:h-[60px] text-white text-center py-5 border-t border-t-gray-800">
                <p className="uppercase">
                    © 2023-2024 MI-CASA-SU-CASA | All rights reserved
                </p>
            </div>
        </>
    );

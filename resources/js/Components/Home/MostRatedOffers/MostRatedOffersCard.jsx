export default function MostRatedOffersCard() {
    return (
        <>
            <>
                <div className="hover:shadow-2xl w-[400px] transition-[0.3s] hover:cursor-pointer">
                    ...
                    <div className="bg-white w-[400px] rounded-b-lg p-3">
                        ...
                        <p className="mb-3 line-clamp-4 w-full">
                            Located in Burgas City, 3.1 km from Burgas Saltworks,
                            Avenue Hotel Deluxe provides air-conditioned rooms and a
                            fitness centre. Among the facilities of this property
                            are a restaurant, a 24-hour front desk and room service,
                            along with free WiFi. Guests can have a drink at the
                            bar.
                        </p>
                        <hr />

        ...
        <>
            ...
            <div className="w-[90%] sm:m-auto mt-8">
                ...
                <SearchBar
                    ...
                    className={"top-0 h-20 mt-[10em] sm:ml-[20em] ml-[3em]"}
                />

                <div className="flex flex-col sm:flex-row justify-between xl:mt-0 mt-[15em]">
                    <div className="flex flex-col sm:w-[25%] w-[50%] ml-[5em] gap-3 mt-[5em]">
        ...
        />
                    ...
                    {estates.length > 0 ? (
                        <div className="flex justify-center mt-[5em] mr-auto">
                            <div className="flex flex-col gap-[2.5em] sm:w-[800px] w-[420px] items-center sm:items-stretch">
                                {records.length > 0 ? (
                                            ...
                                            <div className="flex sm:flex-row flex-col w-[350px] sm:w-full shadow-xl hover:shadow-2xl m-2 rounded-xl">
                                                {estate.images.length > 0 ? (
                                                    <img
                                                        ...
                                                        alt=""
                                                        className="block object-fit sm:w-[250px] h-[230px] w-full rounded-s-xl"
                                                    />
                                                ) : (
                                                    <img
                                                ...
                                                <div className="py-3 px-5 flex flex-col w-full">
                                                    ...
                                                    <div className="w-full mt-auto ml-auto flex justify-end">
                                                        <h2 className="text-[18px]">{estate.price} <span className="font-bold">{estate.currency}</span></h2>
                                                    </div>
                                                </div>
                                            </div>
                                        </Link>

            ...
            <div className="w-[90%] m-auto">
                ...
                <div className="flex flex-col md:flex-row justify-center items-center space-y-3 md:space-y-0 p-4 my-[3em]" aria-label="Table navigation">
                    ...
                    <ul className="inline-flex items-stretch -space-x-px">
                        ...
                        {numbers.map((n, i) => (
                            <li key={i}>
                                <a href="#" onClick={() => changeCurrentPage(n)} className={`${currentPage === n ? 'bg-gray-700' : ''} flex items-center justify-center text-sm py-2 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700  dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white`}>{n}</a>
                            </li>
                        ))}

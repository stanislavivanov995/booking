        ...
        <>
            ...
            <div className="grid min-h-full place-items-center bg-white bg-opacity-70 px-6 py-24 sm:py-32 lg:px-8 border-solid border-2 border-orange-500 rounded-lg shadow-md  ">
                <div className="text-center px-4">
                    ...
                    <p className="mt-4 text-base leading-7 text-gray-900">Sorry, we couldn’t find the page you’re looking for.</p>
                    <div className="mt-10 flex xl:flex-row lg:gap-6 gap-6 flex-col justify-center items-center">
                        <a
                            href="/"

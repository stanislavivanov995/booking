...
import DetailsBookingModal from "./DetailsFeatures/DetailsBookingModal";
...
export default function Details({ auth, estate, facilities, images }) {
    ...
    return (
        <ClientLayout auth={auth}>
            ...
            <DetailsBookingModal auth={auth} estate={estate} setOpenModal={setOpenModal} openModal={openModal} />
                ...
                >
                    ...
                    <div className="bg-white mx-5 my-5 h-[350px] lg:w-[60%] md:w-[80%] sm:w-[30%] xl:w-[60%] 2xl:w-[35%] w-[80%] rounded-xl">
                        ...
                        <div className="flex flex-col h-[80%] items-center  text-[20px] justify-evenly gap-2 mt-5">
                            ...
                            <button
                                className="w-[80%] bg-zinc-800 py-2 rounded-xl text-white px-2 my-5 cursor-pointer m-auto self-end hover:opacity-45 duration-100"
